	...
	foreach ($events['events'] as $event) {
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
			...
			if($type=="template"){
				...
				$template = [
					'type' => 'buttons',
					'text' => 'TITF#20 สวัสดีค่ะ คุณสามารถพิมพ์ถาม Chatbot เรื่องต่อไปนี้ หรือพิมพ์ keyword เกี่ยวกับกิจกรรมหรือสถานที่ท่องเที่ยวเพื่อค้นหาบูธภายในงาน เช่น ดำน้ำ ฮอกไกโด ฯลฯ',
					'actions' => $actions,
				];				
				$messages = [
					'type' => $type,
